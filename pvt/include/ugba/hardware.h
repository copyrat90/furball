...
// Edited by copyrat90:
//     sound register naming scheme changed to Tonc's.
...
_Static_assert(sizeof(oam_entry) == 8, "Wrong oam_entry size");
...
_Static_assert(sizeof(oam_matrix_entry) == 32, "Wrong oam_matrix_entry size");
...
// Sound Registers
#define OFFSET_SND1SWEEP    (0x060) // R/W
#define OFFSET_SND1CNT      (0x062) // R/W
#define OFFSET_SND1FREQ     (0x064) // R/W
#define OFFSET_SND2CNT      (0x068) // R/W
#define OFFSET_SND2FREQ     (0x06C) // R/W
#define OFFSET_SND3SEL      (0x070) // R/W
#define OFFSET_SND3CNT      (0x072) // R/W
#define OFFSET_SND3FREQ     (0x074) // R/W
#define OFFSET_SND4CNT      (0x078) // R/W
#define OFFSET_SND4FREQ     (0x07C) // R/W
#define OFFSET_SNDDMGCNT    (0x080) // R/W
#define OFFSET_SNDDSCNT     (0x082) // R/W
#define OFFSET_SNDSTAT      (0x084) // R/W
#define OFFSET_SNDBIAS      (0x088) // BIOS
...
#define REG_SND1SWEEP       REG_16(OFFSET_SND1SWEEP)
#define REG_SND1CNT         REG_16(OFFSET_SND1CNT)
#define REG_SND1FREQ        REG_16(OFFSET_SND1FREQ)
#define REG_SND2CNT         REG_16(OFFSET_SND2CNT)
#define REG_SND2FREQ        REG_16(OFFSET_SND2FREQ)
#define REG_SND3SEL         REG_16(OFFSET_SND3SEL)
#define REG_SND3CNT         REG_16(OFFSET_SND3CNT)
#define REG_SND3FREQ        REG_16(OFFSET_SND3FREQ)
#define REG_SND4CNT         REG_16(OFFSET_SND4CNT)
#define REG_SND4FREQ        REG_16(OFFSET_SND4FREQ)
#define REG_SNDDMGCNT       REG_16(OFFSET_SNDDMGCNT)
#define REG_SNDDSCNT        REG_16(OFFSET_SNDDSCNT)
#define REG_SNDSTAT         REG_16(OFFSET_SNDSTAT)
#define REG_SNDBIAS         REG_16(OFFSET_SNDBIAS)
...
#define SND1SWEEP_SWEEP_SHIFT_SET(n)  ((n) & 0x7) // R/W
#define SND1SWEEP_SWEEP_SHIFT_GET(n)  ((n) & 0x7)

#define SND1SWEEP_SWEEP_DIR_INC       (0 << 3) // R/W
#define SND1SWEEP_SWEEP_DIR_DEC       (1 << 3)

#define SND1SWEEP_SWEEP_TIME_SET(n)   (((n) & 0x7) << 4) // R/W
#define SND1SWEEP_SWEEP_TIME_GET(n)   (((n) >> 4) & 0x7)

// SND1CNT (NR11, NR12)

#define SND1CNT_LENGTH_SET(n)       ((n) & 0x3F) // WO
#define SND1CNT_LENGTH_GET(n)       ((n) & 0x3F) // Internal use

#define SND1CNT_WAVE_DUTY_GET(n)    (((n) >> 6) & 0x3) // R/W
#define SND1CNT_WAVE_DUTY_12        (0 << 6)
#define SND1CNT_WAVE_DUTY_25        (1 << 6)
#define SND1CNT_WAVE_DUTY_50        (2 << 6)
#define SND1CNT_WAVE_DUTY_75        (3 << 6)

#define SND1CNT_ENV_STEP_TIME_SET(n) (((n) & 0x7) << 8) // R/W
#define SND1CNT_ENV_STEP_TIME_GET(n) (((n) >> 8) & 0x7)

#define SND1CNT_ENV_DIR_DEC         (0 << 11) // R/W
#define SND1CNT_ENV_DIR_INC         (1 << 11)

#define SND1CNT_ENV_VOLUME_SET(n)   (((n) & 0xF) << 12) // R/W
#define SND1CNT_ENV_VOLUME_GET(n)   (((n) >> 12) & 0xF)

// SND1FREQ (NR13, NR14)

#define SND1FREQ_FREQUENCY_SET(n)    ((n) & 0x7FF) // WO
#define SND1FREQ_FREQUENCY_GET(n)    ((n) & 0x7FF) // Internal use

#define SND1FREQ_ONE_SHOT            (1 << 14) // R/W

#define SND1FREQ_RESTART             (1 << 15) // WO

// SND2CNT (NR21, NR22)

#define SND2CNT_LENGTH_SET(n)       ((n) & 0x3F) // WO
#define SND2CNT_LENGTH_GET(n)       ((n) & 0x3F) // Internal use

#define SND2CNT_WAVE_DUTY_GET(n)    (((n) >> 6) & 0x3) // R/W
#define SND2CNT_WAVE_DUTY_12        (0 << 6)
#define SND2CNT_WAVE_DUTY_25        (1 << 6)
#define SND2CNT_WAVE_DUTY_50        (2 << 6)
#define SND2CNT_WAVE_DUTY_75        (3 << 6)

#define SND2CNT_ENV_STEP_TIME_SET(n) (((n) & 0x7) << 8) // R/W
#define SND2CNT_ENV_STEP_TIME_GET(n) (((n) >> 8) & 0x7)

#define SND2CNT_ENV_DIR_DEC         (0 << 11) // R/W
#define SND2CNT_ENV_DIR_INC         (1 << 11)

#define SND2CNT_ENV_VOLUME_SET(n)   (((n) & 0xF) << 12) // R/W
#define SND2CNT_ENV_VOLUME_GET(n)   (((n) >> 12) & 0xF)

// SND2FREQ (NR23, NR24)

#define SND2FREQ_FREQUENCY_SET(n)    ((n) & 0x7FF) // WO
#define SND2FREQ_FREQUENCY_GET(n)    ((n) & 0x7FF) // Internal use

#define SND2FREQ_ONE_SHOT            (1 << 14) // R/W

#define SND2FREQ_RESTART             (1 << 15) // WO

// SND3SEL (NR30)

#define SND3SEL_SIZE_32             (0 << 5)
#define SND3SEL_SIZE_64             (1 << 5)

#define SND3SEL_BANK_SET(n)         (((n) & 1) << 6)
#define SND3SEL_BANK_GET(n)         (((n) >> 6) & 1)

#define SND3SEL_ENABLE              (1 << 7)
#define SND3SEL_DISABLE             (0 << 7)

// SND3CNT (NR31, NR32)

#define SND3CNT_LENGTH_SET(n)       ((n) & 0xFF) // R/W
#define SND3CNT_LENGTH_GET(n)       ((n) & 0xFF)

#define SND3CNT_VOLUME_0            (0x0 << 13) // R/W
#define SND3CNT_VOLUME_25           (0x3 << 13)
#define SND3CNT_VOLUME_50           (0x2 << 13)
#define SND3CNT_VOLUME_75           (0x4 << 13)
#define SND3CNT_VOLUME_100          (0x1 << 13)
#define SND3CNT_VOLUME_MASK         (0x7 << 13)

// SND3FREQ (NR33, NR34)

#define SND3FREQ_SAMPLE_RATE_SET(n)  ((n) & 0x7FF) // WO
#define SND3FREQ_SAMPLE_RATE_GET(n)  ((n) & 0x7FF) // Internal use

#define SND3FREQ_ONE_SHOT            (1 << 14) // R/W

#define SND3FREQ_RESTART             (1 << 15) // WO

// SND4CNT (NR41, NR42)

#define SND4CNT_LENGTH_SET(n)       ((n) & 0x3F) // WO
#define SND4CNT_LENGTH_GET(n)       ((n) & 0x3F) // Internal use

#define SND4CNT_ENV_STEP_TIME_SET(n) (((n) & 0x7) << 8) // R/W
#define SND4CNT_ENV_STEP_TIME_GET(n) (((n) >> 8) & 0x7)

#define SND4CNT_ENV_DIR_DEC         (0 << 11) // R/W
#define SND4CNT_ENV_DIR_INC         (1 << 11)

#define SND4CNT_ENV_VOLUME_SET(n)   (((n) & 0xF) << 12) // R/W
#define SND4CNT_ENV_VOLUME_GET(n)   (((n) >> 12) & 0xF)

// SND4FREQ (NR43, NR44)

#define SND4FREQ_DIV_RATIO_SET(n)    ((n) & 0x7) // R/W
#define SND4FREQ_DIV_RATIO_GET(n)    ((n) & 0x7)

#define SND4FREQ_WIDTH_15_BITS       (0 << 3) // R/W
#define SND4FREQ_WIDTH_7_BITS        (1 << 3)

#define SND4FREQ_FREQUENCY_SET(n)    (((n) & 0xF) << 4) // R/W
#define SND4FREQ_FREQUENCY_GET(n)    (((n) >> 4) & 0xF)

#define SND4FREQ_ONE_SHOT            (1 << 14) // R/W

#define SND4FREQ_RESTART             (1 << 15) // WO

// SNDDMGCNT

#define SNDDMGCNT_PSG_VOL_RIGHT_SET(v) (((v) & 0x7) << 0)
#define SNDDMGCNT_PSG_VOL_RIGHT_GET(v) (((v) >> 0) & 0x7)
#define SNDDMGCNT_PSG_VOL_LEFT_SET(v)  (((v) & 0x7) << 4)
#define SNDDMGCNT_PSG_VOL_LEFT_GET(v)  (((v) >> 4) & 0x7)

#define SNDDMGCNT_PSG_1_ENABLE_RIGHT   (1 << 8)
#define SNDDMGCNT_PSG_2_ENABLE_RIGHT   (1 << 9)
#define SNDDMGCNT_PSG_3_ENABLE_RIGHT   (1 << 10)
#define SNDDMGCNT_PSG_4_ENABLE_RIGHT   (1 << 11)

#define SNDDMGCNT_PSG_1_ENABLE_LEFT    (1 << 12)
#define SNDDMGCNT_PSG_2_ENABLE_LEFT    (1 << 13)
#define SNDDMGCNT_PSG_3_ENABLE_LEFT    (1 << 14)
#define SNDDMGCNT_PSG_4_ENABLE_LEFT    (1 << 15)

// SNDDSCNT

#define SNDDSCNT_PSG_VOLUME_25        (0 << 0)
#define SNDDSCNT_PSG_VOLUME_50        (1 << 0)
#define SNDDSCNT_PSG_VOLUME_100       (2 << 0)
#define SNDDSCNT_PSG_VOLUME_MASK      (3 << 0)

#define SNDDSCNT_DMA_A_VOLUME_50      (0 << 2)
#define SNDDSCNT_DMA_A_VOLUME_100     (1 << 2)

#define SNDDSCNT_DMA_B_VOLUME_50      (0 << 3)
#define SNDDSCNT_DMA_B_VOLUME_100     (1 << 3)

#define SNDDSCNT_DMA_A_ENABLE_RIGHT   (1 << 8)
#define SNDDSCNT_DMA_A_ENABLE_LEFT    (1 << 9)

#define SNDDSCNT_DMA_A_TIMER0         (0 << 10)
#define SNDDSCNT_DMA_A_TIMER1         (1 << 10)

#define SNDDSCNT_DMA_A_RESET          (1 << 11)

#define SNDDSCNT_DMA_B_ENABLE_RIGHT   (1 << 12)
#define SNDDSCNT_DMA_B_ENABLE_LEFT    (1 << 13)

#define SNDDSCNT_DMA_B_TIMER0         (0 << 14)
#define SNDDSCNT_DMA_B_TIMER1         (1 << 14)

#define SNDDSCNT_DMA_B_RESET          (1 << 15)

// SNDSTAT

#define SNDSTAT_PSG_1_IS_ON          (1 << 0) // Read-only flags
#define SNDSTAT_PSG_2_IS_ON          (1 << 1)
#define SNDSTAT_PSG_3_IS_ON          (1 << 2)
#define SNDSTAT_PSG_4_IS_ON          (1 << 3)

#define SNDSTAT_MASTER_ENABLE        (1 << 7)
#define SNDSTAT_MASTER_DISABLE       (0 << 7)

// SNDBIAS

#define SNDBIAS_BIAS_LEVEL_SET(v)     (((v) & 0x1FF) << 1)
#define SNDBIAS_BIAS_LEVEL_GET(v)     (((v) >> 1) & 0x1FF)
#define SNDBIAS_BIAS_MASK             (0x1FF << 1)

#define SNDBIAS_SAMPLE_RATE_32KHZ     (0 << 14) // Best for DMA channels A,B
#define SNDBIAS_SAMPLE_RATE_65KHZ     (1 << 14)
#define SNDBIAS_SAMPLE_RATE_131KHZ    (2 << 14)
#define SNDBIAS_SAMPLE_RATE_262KHZ    (3 << 14) // Best for PSG channels 1-4
