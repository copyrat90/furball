...
LIBFILE	:= $(BUILDLIBDIR)/lib$(PROJECT).a
...
DIRS	:= $(dir $(BUILDDIR)/ $(BUILDLIBDIR)/ $(OBJECTS) $(DEPENDS) $(GEN_S) $(GEN_I))
...
dirs:
	...
	$(SILENT)echo '*' > $(BUILDLIBDIR)/.gitignore

clean:
	@echo "clean $(BUILDLIBDIR), $(BUILDDIR)"
	$(SILENT)rm -rf $(BUILDDIR)
	$(SILENT)rm -rf $(BUILDLIBDIR)
